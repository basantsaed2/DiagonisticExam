...
//   const selectedChapterIds = state?.selectedChapters || [];
...
//         setSelectedPaymentMethod(dataPaymentMethod.payment_methods[0].id);
//       }
//     }
...
//     try {
//       await postData(flattenedPayload,"Purchase successful!");
//       setReceiptFile(null);
...
//             <h2 className="text-2xl font-bold text-gray-800 mb-4">Selected Chapters</h2>
//             <div className="grid gap-4">
//               {selectedChapters.map((chapter) => (
//                 <div
//                   key={chapter.id}
//                   className="p-4 rounded-xl border border-mainColor/20 bg-mainColor/5"
//                 >
//                   <div className="flex items-center justify-between">
//                     <div>
//                       <h3 className="font-semibold text-gray-800">{chapter.chapter_name}</h3>
//                       <p className="text-sm text-gray-500">Min Price: ${chapter.min_price}</p>
//                     </div>
//                     <select
//                       value={chapterDurations[chapter.id] || ""}
//                       onChange={(e) => handleDurationChange(chapter.id, e.target.value)}
//                       className="border border-gray-300 rounded-lg p-2 focus:ring-mainColor focus:border-mainColor"
//                     >
//                       {chapter.price.map((p) => (
...
//                       />
//                       <span className="text-gray-800 font-medium">{method.payment}</span>
//                     </div>
//                   </label>
//                   {selectedPaymentMethod === method.id && (
...
//                       {method.payment !== "Paymob" && method.id !== 10 && (
//                         <div className="mt-4">
...
//                               className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-mainColor/10 file:text-mainColor hover:file:bg-mainColor/20"
//                             />
//                             <FaUpload className="text-mainColor" />
//                           </div>
//                           {receiptPreview && (
//                             <div className="mt-4">
//                               <img
...
//           <p className="text-xl font-semibold text-mainColor">${calculateTotalAmount()}</p>
//         </div>
...
//             disabled={loadingPost || selectedChapterIds.length === 0 || !selectedPaymentMethod}
//             className="flex items-center gap-2 px-6 py-3 bg-mainColor text-white rounded-lg hover:bg-mainColor/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
//           >
//             {loadingPost ? (
//               <>
