...
//     const passStatus = examData.score >= examData.pass_score;
...
//                     <div class Eletype="button" className="inline-flex items-center gap-2 bg-mainColor/10 px-4 py-2 rounded-lg">
...
//                                     <p className="text-lg font-bold text-gray-800">{examData.exam?.time}</p>
...
//                                 <p className="text-gray-600">Select chapters to purchase or click to study</p>
//                             </div>
//                         </div>
...
//                                 <div
//                                     key={chapter.id}
//                                     className="group flex items-center p-4 bg-mainColor/5 rounded-xl border border-mainColor/20 hover:border-mainColor hover:bg-mainColor/10 transition-all duration-300"
//                                 >
//                                     <input
//                                         type="checkbox"
//                                         checked={selectedChapters.includes(chapter.id)}
//                                         onChange={() => handleChapterToggle(chapter.id)}
//                                         className="h-5 w-5 text-mainColor border-gray-300 rounded focus:ring-mainColor mr-4"
//                                     />
//                                     <Link
//                                         to={`/chapters/${chapter.id}`}
//                                         className="flex-1 flex items-center"
//                                     >
//                                         <div className="w-10 h-10 bg-mainColor text-white rounded-lg flex items-center justify-center font-semibold mr-4">
//                                             {index + 1}
//                                         </div>
//                                         <div>
...
//                                             </h3>
//                                             <p className="text-sm text-gray-500 mt-1">Click to study</p>
//                                         </div>
//                                     </Link>
//                                 </div>
//                             ))}
...
//                             <Link
//                                 to="/buy_chapters"
//                                 state={{ examData, selectedChapters }}
